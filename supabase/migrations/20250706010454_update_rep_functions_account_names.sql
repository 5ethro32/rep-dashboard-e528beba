-- Update Daily Rep Performance Functions to show Active/Total Accounts
-- Active = accounts that transacted in the period
-- Total = all accounts assigned to that rep (via Rep or Sub-Rep field)
