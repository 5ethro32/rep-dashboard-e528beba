    ...
    <div className="overflow-x-auto w-full -mx-3 md:mx-0">
      <div className="min-w-full">
        <div className="max-h-[600px] overflow-y-auto relative">
          <Table>
            <TableHeader className="bg-black/20 backdrop-blur-sm sticky top-0 z-30">
              <TableRow className="bg-black/20 hover:bg-black/30">
                <TableHead 
                  onClick={() => onSort('rep')}
                  className="px-3 md:px-6 py-2 md:py-3 text-left text-2xs md:text-xs font-medium text-finance-gray uppercase cursor-pointer hover:bg-white/5 transition-colors sticky left-0 z-40 bg-gray-900/90 backdrop-blur-sm border-r border-white/5"
                >
