  ...
  return (
    <button
      ...
      className={cn(
        ...
        checked 
          ? "bg-gradient-to-r from-finance-red to-rose-700 border-transparent text-white"
          : "bg-transparent border-white/30 text-white/70 hover:bg-white/10 hover:text-white",
        className
      )}
    >
      {children}
